...
if __name__ == "__main__":
  ...
  parser.add_argument('--search-query', type=str,
                      ...
                      default='cat:cs.CV+OR+cat:cs.AI+OR+cat:cs.LG+OR+cat:cs.CL+OR+cat:cs.NE+OR+cat:cs.NE+OR+cat:cs.HC+OR+cat:stat.CE+OR+cat:stat.ML',
  ...
  parser.add_argument('--wait-time', type=float, default=8.0, help='lets be gentle to arxiv API (in number of seconds)')
  ...
  for i in range(args.start_index, args.max_index, args.results_per_iteration):
    with open("./fetch_start.txt",'w') as f_count:
        f_count.write(str(i))
